        ...
        try {
            ...
            if (menuRes.data.insertedId) {
                ...
                Swal.fire({
                    position: "center",
                    icon: "success",
                    title: `Successfully added ${menuItem.name}`,
            ...
            <div>
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="form-control w-full">
                        ...
                        <input required {...register("name", { required: true })} type="text" placeholder="Recipe name" className="input input-bordered w-full " />
                    </div>
                    ...
                    <div className="flex gap-5">
                        ...
                        <div className="form-control w-full">
                            ...
                            <select defaultValue={'default'} {...register("category", { required: true })} className="select select-warning w-full">
                        ...
                        <div className="form-control w-full">
                            ...
                            <input required {...register("price", { required: true })} type="number" placeholder="Price" className="input input-bordered w-full " />
                        </div>
                    </div>
