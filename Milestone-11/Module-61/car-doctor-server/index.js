...
app.use(cors({
    origin: [
        // 'http://localhost:5173',
        'https://car-doctors-f1e60.web.app',
        'https://car-doctors-f1e60.firebaseapp.com'
    ], //don't forget to change it in production level
    credentials: true
    ...
    try {
        ...
        app.post('/jwt', async (req, res) => {
            ...
            res
                .cookie('token', token, {
                    httpOnly: true,
                    secure: true, //http://localhost:5000/
        ...
        app.post('/logout', async (req, res) => {
            ...
            res
                .clearCookie('token', {
                    //  to prevent production level issue  use same options as set cookie options
                    maxAge: 0,
                    httpOnly: true,
                    secure: true,
                    sameSite: 'none',
